...
<div id="baton-baton-conductor-enhanced-hero-2" class="baton-hero-widget widget baton-baton-conductor-enhanced" style="<?php echo esc_attr( $featured_image_style ); ?>">
	<div class="in baton-baton-conductor-enhanced-in cf">
		<div class="baton-baton-conductor-enhanced-wrapper baton-hero-2 baton-baton-conductor-enhanced-baton-hero-2 baton-hero baton-baton-conductor-enhanced-baton-hero">
